...
from settings.train_options import TrainCompOptions
...
if __name__ == '__main__':
    ...
    if opt.dataset_name == 't2m':
        ...
        opt.data_root = '/content/drive/MyDrive/KIT-ML/'
        opt.motion_dir = pjoin(opt.data_root, 'new_joint_vecs')
        opt.text_dir = pjoin(opt.data_root, 'texts')
        opt.joints_num = 21
        radius = 240 * 8
        ...
        opt.data_root = '/content/drive/MyDrive/dataFolder/PositionalData'
